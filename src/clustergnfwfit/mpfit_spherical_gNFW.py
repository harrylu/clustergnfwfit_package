...
def myfunctgnfw_simul(p, fjac=None, R500=None, y150=None, y90=None, err150=None, err90=None, beam_handler_150=None, beam_handler_90=None, excise_regions=None, num_processes=None):
    ...
    # p is (P0_150, P0_90, RS (arcseconds), x_offset (pixels), y_offset (pixels), c_150, c_90)
...
def mpfit_3dgnfw_simultaneous(R500, beam_handler_150, beam_handler_90, y150, y90, err150, err90, parinfo, excise_regions=None, num_processes=4):
